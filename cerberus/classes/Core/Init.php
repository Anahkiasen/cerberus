...
use Cerberus\Core\Config,
    ...
    Cerberus\Core\Update,
    Cerberus\Modules\Browser,
    Cerberus\Toolkit\Database  as db,
    Cerberus\Toolkit\Directory as dir,
    Cerberus\Toolkit\File      as f,
    Cerberus\Toolkit\Language  as l,
    Cerberus\Toolkit\Server,
    Cerberus\Toolkit\Session,
...
class Init
{
  ...
  /**
   * Declare Kirby base functions
   */
  public function kirbyCore()
  {
    /**
  ...
  public function iniPHP()
  {
    ...
    foreach($ini as $i => $v) ini_set($i, $v);
  }
  ...
  */
  public function errorHandling()
  {
    ...
    // Loading errorHandle
    if(!function_exists('errorHandle')) include(PATH_CORE.'functions/errorHandle.php');
    set_error_handler('errorHandle');
    set_exception_handler(array('Cerberus\Core\Debug', 'handle'));
  ...
  */
  public function autoloader()
  {
    ...
    if(function_exists('classLoader')) return true;

    // Include the Autoloader and set it as main loader
    include(PATH_CORE.'classloader.php');
  ...
  */
  ...
  {
    l::locale('fr');
    l::load('cerberus/locale/{langue}.json');
  }
