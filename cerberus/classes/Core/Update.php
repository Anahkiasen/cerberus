...
class Update
{
   ...
   * @var string
   */
  private static $last = '2012-06-27,2e3a77a9936c0636a9c5607350a6210eb160683d';
  ...
  public function __construct()
  {
    ...
    if (self::outdate('2012-06-08')) {
      self::codematch('new forms\(', 'new Form(');
    }
    ...
    if (self::outdate('2012-06-27')) {
      self::codematch('new form\(', 'new FormDeprecated(');
      self::codematch('new Form\(', 'new FormDeprecated(');
      self::codematch('new forms\(', 'new Form(');
      self::codematch('new Forms\(', 'new Form(');
      self::codematch('new select\(', 'new SelectDeprecated(');
      self::codematch('new Select\(', 'new SelectDeprecated(');
    }
    ...
    switch ($table) {
      ...
      case 'cerberus_structure':
        db::execute('CREATE TABLE `cerberus_structure` (
          ...
          `parent_priority` tinyint(3) NOT NULL DEFAULT \'0\',
          `page_priority` tinyint(3) NOT NULL DEFAULT \'0\',
