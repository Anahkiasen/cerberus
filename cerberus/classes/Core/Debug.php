...
class Debug extends \Exception
{
  ...
  public static function handle($exception, $message = null, $type = null, $params = array())
  {
    ...
    if(defined('LOCAL') and defined('DEBUG') and DEBUG and LOCAL) echo self::render();
    else self::send();
  }
  ...
  private static function render()
  {
    ...
    foreach ($e->getTrace() as $i => $t) {
      ...
      $render .= '<div style="margin-left:' .($i * 25). 'px">';
        $render .= '<h3>' .basename(Arrays::get($t, 'file')). '[' .Arrays::get($t, 'line'). ']</h3>';
  ...
  {
    $params = Arrays::simplify($params, false);
