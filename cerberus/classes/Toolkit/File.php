...
class File
{
  ...
  */
   ...
   *
   * self::rename('path/folder/file.php', 'renamed') will per example execute
  ...
  */
   ...
   * @param  string  $fallback A fallback type to assign the file if none found
   * @return string  The filetype
   */
  public static function type($file, $fallback = null)
  {
