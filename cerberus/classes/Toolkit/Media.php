...
class Media
{
  ...
  public static function timthumb($file, $width = null, $height = null, $params = array())
  {
    ...
    return PATH_CORE.'classes/Vendor/timthumb.php?src=' .$file. '&' .a::glue($params, '&', '=');
  }
   ...
   */
  public static function thumb($file, $width = null, $height = null, $attributes = array(), $params = array())
  {
