...
class browser
{
	static public $ua = false; // Entire agent string
	static public $name = false; // Readable name of the browser
	static public $engine = false; // Readable browser engine name
	static public $version = false; // Browser version number
	static public $platform = false; // Platform name
	static public $mobile = false; // Mobile device or not
