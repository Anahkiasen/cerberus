...
class cache
{
   ...
   */
	 ...
	 */
	public static function fetch($name, $content = null, $params = array())
	{
	 ...
	 */
	public static function page($page, $params = array())
	{
	 ...
	 */
	public static function save($return = false)
	{
		if(self::$cached_file)
		{
	 ...
	 */
	public static function search($search, $all_files = false, $sloppy = false)
	{
		self::init();
	 ...
	 */
	public static function delete($delete = null, $sloppy = false)
	{
		if(!$delete) $delete = '*';
	 ...
	 */
	public static function manifest($cache = array('img', 'fonts', 'video'), $network = '*', $fallback = null)
	{
